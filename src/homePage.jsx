    ...
    >
      <div
        ...
        style={{
          ...
          minWidth: sideBarOpen ? "150px" : "0",
          backgroundColor: sideBarOpen ? " rgb(5, 85, 155)" : "transparent",
              ...
              {todo.map((todoItem) => (
                ...
                >
                  ...
                  <td style={{ textAlign: "right" }}>
                    <button
                      onClick={() => markDone(todoItem.id, todoItem.completed)}
                    >
                      {todoItem.completed ? "Not Done" : "Done"}
                    </button>
                  </td>
                  <td>
                    <button
